...
NETPLUS.questions.push(
  { id:"D1-001", domain:1, obj:"1.1", diff:"easy", q:"At which layer of the OSI model do IP addresses operate to make routing decisions?", options:["Layer 2 (Data Link)","Layer 3 (Network)","Layer 4 (Transport)","Layer 7 (Application)"], answer:1, explain:"<strong>Layer 3 (Network)</strong> handles logical addressing and path selection using IP addresses, which routers read to make routing decisions.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Layer 2 (Data Link)</b>: Layer 2 uses physical MAC addresses for local frame delivery within a single segment, not the logical IP addresses used to route between networks.</span><span class='qd'><b>Layer 4 (Transport)</b>: Layer 4 manages end-to-end segmentation and ports such as TCP and UDP, not the addressing routers use to forward packets.</span><span class='qd'><b>Layer 7 (Application)</b>: Layer 7 provides services to applications such as HTTP and DNS and never makes hop-by-hop routing decisions.</span>" },
  { id:"D1-002", domain:1, obj:"1.1", diff:"easy", q:"Which OSI layer is responsible for converting data into electrical, optical, or radio signals on the physical medium?", options:["Layer 1 (Physical)","Layer 2 (Data Link)","Layer 3 (Network)","Layer 4 (Transport)"], answer:0, explain:"The <strong>Physical layer (Layer 1)</strong> defines how raw bits are transmitted as electrical, optical, or radio signals across the medium.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Layer 2 (Data Link)</b>: Layer 2 organizes bits into frames and handles MAC addressing, but it does not encode the actual signals onto the wire.</span><span class='qd'><b>Layer 3 (Network)</b>: Layer 3 handles logical IP addressing and routing, which is independent of the signaling on the medium.</span><span class='qd'><b>Layer 4 (Transport)</b>: Layer 4 deals with segmentation and reliable delivery, far above the physical signaling described here.</span>" },
  { id:"D1-003", domain:1, obj:"1.4", diff:"easy", q:"Which port number does SSH use by default?", options:["21","22","23","25"], answer:1, explain:"<strong>SSH uses TCP port 22</strong> to provide encrypted remote login and command execution.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>21</b>: Port 21 is the FTP control channel, an unrelated cleartext file-transfer protocol.</span><span class='qd'><b>23</b>: Port 23 is Telnet, an unencrypted remote-access protocol that SSH was designed to replace.</span><span class='qd'><b>25</b>: Port 25 is SMTP for server-to-server email transfer, not remote shell access.</span>" },
  { id:"D1-004", domain:1, obj:"1.4", diff:"easy", q:"What transport protocol and port does HTTPS use?", options:["UDP 80","TCP 443","TCP 8080","UDP 443"], answer:1, explain:"<strong>HTTPS uses TCP port 443</strong> to carry web traffic secured by TLS.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>UDP 80</b>: Port 80 is plain HTTP and it runs over TCP, not UDP, and it is unencrypted.</span><span class='qd'><b>TCP 8080</b>: Port 8080 is a common alternate HTTP proxy or web port, not the standard HTTPS port.</span><span class='qd'><b>UDP 443</b>: Although QUIC and HTTP/3 use UDP 443, classic HTTPS over TLS uses TCP 443, so the standard answer is TCP.</span>" },
  { id:"D1-005", domain:1, obj:"1.4", diff:"easy", q:"Which protocol resolves domain names to IP addresses and primarily uses port 53?", options:["DHCP","DNS","SNMP","LDAP"], answer:1, explain:"<strong>DNS</strong> resolves hostnames to IP addresses using port 53, with UDP for most queries and TCP for zone transfers and large responses.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>DHCP</b>: DHCP automatically assigns IP configuration to clients using UDP 67 and 68, not name resolution on port 53.</span><span class='qd'><b>SNMP</b>: SNMP monitors and manages network devices over UDP 161 and 162, not domain name lookups.</span><span class='qd'><b>LDAP</b>: LDAP queries directory services over port 389, not the DNS hierarchy on port 53.</span>" },
  ...
  { id:"D1-007", domain:1, obj:"1.2", diff:"easy", q:"Which device operates primarily at Layer 2 and forwards frames based on MAC addresses?", options:["Hub","Switch","Router","Repeater"], answer:1, explain:"A <strong>switch</strong> builds a MAC address table and forwards frames at Layer 2 toward only the port where the destination resides.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Hub</b>: A hub is a Layer 1 device that blindly repeats incoming signals out every port without reading MAC addresses.</span><span class='qd'><b>Router</b>: A router operates at Layer 3, forwarding packets between networks based on IP addresses rather than MAC frames.</span><span class='qd'><b>Repeater</b>: A repeater is a Layer 1 device that regenerates a signal to extend distance and has no awareness of MAC addresses.</span>" },
  { id:"D1-008", domain:1, obj:"1.2", diff:"easy", q:"What is the primary function of a router?", options:["Amplify electrical signals","Connect and route traffic between different networks","Convert digital to analog signals","Assign MAC addresses to hosts"], answer:1, explain:"A <strong>Connect and route traffic between different networks</strong> describes a router, which forwards packets between separate networks using Layer 3 addressing and a routing table.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Amplify electrical signals</b>: Amplifying or regenerating signals is the job of a repeater or amplifier at Layer 1, not a router.</span><span class='qd'><b>Convert digital to analog signals</b>: Digital-to-analog conversion is performed by a modem, not a router.</span><span class='qd'><b>Assign MAC addresses to hosts</b>: MAC addresses are burned into network interface cards by the manufacturer and are never assigned by a router.</span>" },
  { id:"D1-009", domain:1, obj:"1.5", diff:"easy", q:"Which copper cable category is rated for 10GBASE-T over the full 100 meters?", options:["Cat 5","Cat 5e","Cat 6","Cat 6a"], answer:3, explain:"<strong>Cat 6a</strong> supports 10GBASE-T over the full 100 meters because its tighter specifications and shielding limit alien crosstalk.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Cat 5</b>: Cat 5 is rated only for 100 Mbps and cannot reliably carry gigabit, let alone 10 Gbps.</span><span class='qd'><b>Cat 5e</b>: Cat 5e supports 1 Gbps to 100 m but is not rated for 10 Gbps.</span><span class='qd'><b>Cat 6</b>: Cat 6 carries 10 Gbps only to roughly 55 m due to crosstalk, not the full 100 m.</span>" },
  ...
  { id:"D1-011", domain:1, obj:"1.4", diff:"easy", q:"Which protocol is connection-oriented and provides reliable, ordered delivery using acknowledgments?", options:["UDP","TCP","ICMP","ARP"], answer:1, explain:"<strong>TCP</strong> is connection-oriented and provides reliable, ordered delivery using sequence numbers and acknowledgments.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>UDP</b>: UDP is connectionless and best-effort, sending datagrams without acknowledgments or guaranteed ordering.</span><span class='qd'><b>ICMP</b>: ICMP is a Layer 3 control and error-reporting protocol used by tools like ping, not a reliable transport protocol.</span><span class='qd'><b>ARP</b>: ARP resolves IP addresses to MAC addresses on a local segment and provides no data delivery service.</span>" },
  { id:"D1-012", domain:1, obj:"1.4", diff:"easy", q:"What port does SMTP use for sending email between mail servers?", options:["25","110","143","993"], answer:0, explain:"<strong>SMTP uses TCP port 25</strong> for server-to-server mail relay between mail transfer agents.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>110</b>: Port 110 is POP3, used by clients to download mail, not to send it between servers.</span><span class='qd'><b>143</b>: Port 143 is IMAP, used by clients to access mailboxes, not for server-to-server sending.</span><span class='qd'><b>993</b>: Port 993 is IMAPS, the TLS-encrypted version of IMAP retrieval, not SMTP transfer.</span>" },
  { id:"D1-013", domain:1, obj:"1.1", diff:"easy", q:"Which OSI layer is responsible for end-to-end segmentation and reliable delivery using TCP?", options:["Layer 2 (Data Link)","Layer 3 (Network)","Layer 4 (Transport)","Layer 5 (Session)"], answer:2, explain:"The <strong>Transport layer (Layer 4)</strong> performs end-to-end segmentation, flow control, and reliable delivery using TCP, or fast best-effort delivery using UDP.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Layer 2 (Data Link)</b>: Layer 2 handles local frame delivery and MAC addressing, not end-to-end reliability.</span><span class='qd'><b>Layer 3 (Network)</b>: Layer 3 handles logical addressing and routing of packets, not segmentation or acknowledgments.</span><span class='qd'><b>Layer 5 (Session)</b>: Layer 5 manages dialogue setup and teardown between applications, not the reliable segment delivery TCP provides.</span>" },
  ...
  { id:"D1-027", domain:1, obj:"1.4", diff:"medium", q:"Which protocol uses UDP port 67 and 68 to automatically assign IP configuration to hosts?", options:["DNS","DHCP","ARP","NTP"], answer:1, explain:"<strong>DHCP</strong> uses UDP ports 67 (server) and 68 (client) to lease IP addresses and related configuration to hosts automatically.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>DNS</b>: DNS resolves names to IP addresses on port 53 and does not assign IP configuration.</span><span class='qd'><b>ARP</b>: ARP maps a known IP to a MAC address on the local segment and does not lease addresses.</span><span class='qd'><b>NTP</b>: NTP synchronizes clocks over UDP 123 and has nothing to do with IP assignment.</span>" },
  { id:"D1-028", domain:1, obj:"1.4", diff:"medium", q:"A user reports that secure web pages fail but unencrypted pages load. Which port is MOST likely being blocked?", options:["TCP 80","TCP 443","UDP 53","TCP 25"], answer:1, explain:"Secure web pages use <strong>TCP 443</strong> for HTTPS, so if encrypted sites fail while plain HTTP still loads, port 443 is the likely block.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>TCP 80</b>: Port 80 is plain HTTP, and unencrypted pages are working, so 80 is not blocked.</span><span class='qd'><b>UDP 53</b>: Port 53 is DNS, and if name resolution failed both secure and unsecure sites would break, not just HTTPS.</span><span class='qd'><b>TCP 25</b>: Port 25 is SMTP email transfer and is unrelated to loading web pages.</span>" },
  { id:"D1-029", domain:1, obj:"1.1", diff:"medium", q:"During encapsulation, what does the Transport layer add to the data it receives from upper layers?", options:["A frame trailer with FCS","A packet header with source/destination IP","A segment header with source/destination ports","Physical line coding"], answer:2, explain:"The <strong>A segment header with source/destination ports</strong> is added at the Transport layer, which builds segments containing port numbers and sequencing.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>A frame trailer with FCS</b>: A frame trailer with a frame check sequence is added at Layer 2, the Data Link layer, not the Transport layer.</span><span class='qd'><b>A packet header with source/destination IP</b>: An IP header with source and destination addresses is added at Layer 3, the Network layer.</span><span class='qd'><b>Physical line coding</b>: Line coding of bits onto the medium occurs at Layer 1, the Physical layer.</span>" },
  { id:"D1-030", domain:1, obj:"1.4", diff:"medium", q:"Which protocols correctly map to their default ports for retrieving email?", options:["POP3 110 and IMAP 143","POP3 143 and IMAP 110","POP3 25 and IMAP 110","POP3 993 and IMAP 995"], answer:0, explain:"<strong>POP3 110 and IMAP 143</strong> is correct, since POP3 retrieves mail on TCP 110 and IMAP accesses mailboxes on TCP 143.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>POP3 143 and IMAP 110</b>: This swaps the two ports, since 143 is IMAP and 110 is POP3.</span><span class='qd'><b>POP3 25 and IMAP 110</b>: Port 25 is SMTP sending and 110 is POP3, so neither pairing is correct for IMAP retrieval.</span><span class='qd'><b>POP3 993 and IMAP 995</b>: These are the secure variants reversed, since 995 is POP3S and 993 is IMAPS.</span>" },
  { id:"D1-031", domain:1, obj:"1.2", diff:"medium", q:"A network engineer needs to convert a copper Ethernet link to fiber to extend a run beyond 100 meters. Which device is appropriate?", options:["Repeater","Media converter","Bridge","Content filter"], answer:1, explain:"A <strong>Media converter</strong> transparently translates between copper and fiber, letting a run continue on fiber beyond the 100 m copper limit.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Repeater</b>: A repeater regenerates a signal on the same medium and cannot convert copper to fiber.</span><span class='qd'><b>Bridge</b>: A bridge connects and filters traffic between Layer 2 segments but does not convert physical media.</span><span class='qd'><b>Content filter</b>: A content filter inspects and blocks traffic based on policy and has no role in media conversion.</span>" },
  { id:"D1-032", domain:1, obj:"1.5", diff:"medium", q:"Which transceiver form factor supports speeds up to 100 Gbps and is commonly used in data center switches?", options:["SFP","SFP+","QSFP28","GBIC"], answer:2, explain:"<strong>QSFP28</strong> is a quad small form-factor pluggable transceiver that supports 100 Gbps and is widely used in data center switches.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>SFP</b>: SFP tops out at about 1 Gbps, far below 100 Gbps.</span><span class='qd'><b>SFP+</b>: SFP+ supports up to 10 Gbps, which is one tenth of the required speed.</span><span class='qd'><b>GBIC</b>: GBIC is an older, larger 1 Gbps form factor that predates 100 Gbps optics.</span>" },
  { id:"D1-033", domain:1, obj:"1.4", diff:"medium", q:"Which protocol uses TCP port 636 to provide directory services securely over TLS?", options:["LDAP","LDAPS","Kerberos","RADIUS"], answer:1, explain:"<strong>LDAPS</strong> uses TCP port 636 to encrypt directory queries with TLS.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>LDAP</b>: Plain LDAP uses TCP 389 and sends directory queries unencrypted.</span><span class='qd'><b>Kerberos</b>: Kerberos provides ticket-based authentication on port 88, not directory lookups over TLS on 636.</span><span class='qd'><b>RADIUS</b>: RADIUS handles AAA on UDP 1812 and 1813, not directory services on 636.</span>" },
  ...
  { id:"D1-043", domain:1, obj:"1.1", diff:"hard", q:"A packet capture shows traffic being fragmented and reassembled with TTL decrements at each hop. At which OSI layer is the TTL field processed?", options:["Layer 2 (Data Link)","Layer 3 (Network)","Layer 4 (Transport)","Layer 5 (Session)"], answer:1, explain:"The <strong>Layer 3 (Network)</strong> layer processes the TTL field, since TTL lives in the IP header and each router decrements it.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Layer 2 (Data Link)</b>: Layer 2 frames have no TTL field, since TTL is part of the IP header at Layer 3.</span><span class='qd'><b>Layer 4 (Transport)</b>: TCP and UDP headers at Layer 4 do not contain the TTL field.</span><span class='qd'><b>Layer 5 (Session)</b>: The Session layer manages dialogues and has nothing to do with the IP TTL field.</span>" },
  { id:"D1-044", domain:1, obj:"1.4", diff:"hard", q:"An application requires the LOWEST latency and can tolerate occasional packet loss, such as live VoIP. Which transport protocol behavior BEST supports this?", options:["TCP, because retransmission ensures quality","UDP, because it avoids handshake and retransmission overhead","ICMP, because it is connectionless","TCP with a larger window size only"], answer:1, explain:"<strong>UDP, because it avoids handshake and retransmission overhead</strong> suits live VoIP, which prefers low latency and can tolerate occasional loss.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>TCP, because retransmission ensures quality</b>: TCP retransmission adds delay and jitter that harm real-time voice rather than helping it.</span><span class='qd'><b>ICMP, because it is connectionless</b>: ICMP is a control and diagnostic protocol and is not used to carry application media streams.</span><span class='qd'><b>TCP with a larger window size only</b>: A larger TCP window does not remove the handshake and retransmission delays that make TCP a poor fit for live voice.</span>" },
  { id:"D1-045", domain:1, obj:"1.1", diff:"hard", q:"A user cannot reach a website by name, but pinging the site's IP succeeds. Considering the OSI model, the problem MOST likely involves a protocol operating at which layer?", options:["Layer 1 (Physical)","Layer 3 (Network)","Layer 7 (Application)","Layer 2 (Data Link)"], answer:2, explain:"Name resolution depends on <strong>Layer 7 (Application)</strong> via DNS, so since the IP is reachable, lower layers work and DNS is the likely fault.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Layer 1 (Physical)</b>: A successful ping to the IP proves the physical link is up, so Layer 1 is not the issue.</span><span class='qd'><b>Layer 3 (Network)</b>: Reaching the IP by ping confirms Layer 3 routing works, ruling out a Network-layer fault.</span><span class='qd'><b>Layer 2 (Data Link)</b>: Successful packet delivery shows frames are being forwarded, so Layer 2 is functioning.</span>" },
...
NETPLUS.questions.push(
  ...
  { id:"D1-107", domain:1, obj:"1.7", diff:"hard", q:"A /22 network is summarized from four contiguous /24s. Which set of networks aggregates into 192.168.4.0/22?", options:["192.168.4.0, 192.168.5.0, 192.168.6.0, 192.168.7.0","192.168.0.0, 192.168.1.0, 192.168.2.0, 192.168.3.0","192.168.4.0, 192.168.8.0, 192.168.12.0, 192.168.16.0","192.168.2.0, 192.168.3.0, 192.168.4.0, 192.168.5.0"], answer:0, explain:"<strong>192.168.4.0, 192.168.5.0, 192.168.6.0, 192.168.7.0</strong> is correct because a /22 starting at 192.168.4.0 covers 192.168.4.0 through 192.168.7.255, exactly those four contiguous /24s.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>192.168.0.0, 192.168.1.0, 192.168.2.0, 192.168.3.0</b>: These aggregate into 192.168.0.0/22, not the 192.168.4.0/22 block requested.</span><span class='qd'><b>192.168.4.0, 192.168.8.0, 192.168.12.0, 192.168.16.0</b>: These are not contiguous /24s, so they cannot summarize into a single /22.</span><span class='qd'><b>192.168.2.0, 192.168.3.0, 192.168.4.0, 192.168.5.0</b>: This block does not align on a /22 boundary (which must start on a multiple of 4 in the third octet) so it cannot summarize cleanly.</span>" },
  { id:"D1-108", domain:1, obj:"1.8", diff:"medium", q:"Which use case BEST describes IoT and SCADA networks compared with traditional IT networks?", options:["They never require segmentation","They often use specialized protocols and benefit from isolation from general IT traffic","They always use IPv6 only","They cannot be monitored"], answer:1, explain:"<strong>They often use specialized protocols and benefit from isolation from general IT traffic</strong> is correct because IoT and SCADA/ICS systems frequently run legacy or specialized protocols and are commonly segmented for security and reliability.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>They never require segmentation</b>: These systems often require segmentation more than typical IT due to fragile, legacy protocols.</span><span class='qd'><b>They always use IPv6 only</b>: Many IoT and SCADA devices use IPv4 or proprietary protocols, so IPv6-only is false.</span><span class='qd'><b>They cannot be monitored</b>: These networks can and should be monitored, often with specialized OT monitoring tools.</span>" },
  { id:"D1-109", domain:1, obj:"1.8", diff:"hard", q:"An organization wants to deliver compute closer to end users to reduce latency for real-time applications. Which approach is the BEST fit?", options:["Centralized data center only","Edge computing","Cold storage tiering","Full mesh WAN"], answer:1, explain:"<strong>Edge computing</strong> is correct because it processes data near its source, lowering latency for real-time and IoT workloads.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Centralized data center only</b>: A single distant data center adds latency, the opposite of what real-time applications need.</span><span class='qd'><b>Cold storage tiering</b>: Cold storage is for infrequently accessed data and does not reduce compute latency for users.</span><span class='qd'><b>Full mesh WAN</b>: A full mesh WAN improves site interconnection but does not move compute closer to end users.</span>" },
  { id:"D1-110", domain:1, obj:"1.7", diff:"medium", q:"Which address represents the IPv4 loopback used to test the local TCP/IP stack?", options:["127.0.0.1","0.0.0.0","255.255.255.255","169.254.0.1"], answer:0, explain:"<strong>127.0.0.1</strong> is correct because it is the IPv4 loopback address used to verify the local TCP/IP stack.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>0.0.0.0</b>: This represents an unspecified address or default route, not loopback.</span><span class='qd'><b>255.255.255.255</b>: This is the limited broadcast address, not loopback.</span><span class='qd'><b>169.254.0.1</b>: This is an APIPA link-local address, not loopback.</span>" },
  { id:"D1-111", domain:1, obj:"1.7", diff:"hard", q:"For the host 192.168.50.200/27, which range represents its usable host addresses?", options:["192.168.50.193 - 192.168.50.222","192.168.50.192 - 192.168.50.223","192.168.50.200 - 192.168.50.231","192.168.50.224 - 192.168.50.254"], answer:0, explain:"<strong>192.168.50.193 - 192.168.50.222</strong> is correct because a /27 uses 32-wide blocks; .200 falls in 192-223 with network .192 and broadcast .223, leaving .193 through .222 usable.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>192.168.50.192 - 192.168.50.223</b>: This includes the network address .192 and broadcast .223, which are not usable host addresses.</span><span class='qd'><b>192.168.50.200 - 192.168.50.231</b>: This range does not align to the /27 boundary of 192 and crosses into the next subnet.</span><span class='qd'><b>192.168.50.224 - 192.168.50.254</b>: This is the next /27 subnet (224-255), not the one containing .200.</span>" },
  { id:"D1-112", domain:1, obj:"1.3", diff:"medium", q:"Which cloud characteristic allows resources to automatically scale up or down based on demand?", options:["Multitenancy","Elasticity","Geo-redundancy","Throughput"], answer:1, explain:"<strong>Elasticity</strong> is correct because rapid elasticity lets cloud resources automatically expand or contract to match workload demand.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Multitenancy</b>: Multitenancy means multiple customers share the same infrastructure, not automatic scaling.</span><span class='qd'><b>Geo-redundancy</b>: Geo-redundancy replicates resources across regions for availability, not on-demand scaling.</span><span class='qd'><b>Throughput</b>: Throughput is a performance measure of data moved per unit time, not a scaling characteristic.</span>" },
  { id:"D1-113", domain:1, obj:"1.3", diff:"easy", q:"In cloud networking, what does a security group function as?", options:["A physical firewall appliance","A virtual, stateful filter controlling traffic to cloud resources","A DNS resolver","A load balancer"], answer:1, explain:"<strong>A virtual, stateful filter controlling traffic to cloud resources</strong> is correct because a cloud security group acts as a stateful virtual firewall defining allowed inbound and outbound traffic for instances.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>A physical firewall appliance</b>: A security group is a software construct in the cloud platform, not a physical appliance.</span><span class='qd'><b>A DNS resolver</b>: A DNS resolver answers name queries and performs no traffic filtering.</span><span class='qd'><b>A load balancer</b>: A load balancer distributes traffic across targets and does not act as a stateful packet filter.</span>" },
...
{ id:"D2-016", domain:2, obj:"2.1", diff:"medium", q:"What is the primary purpose of First Hop Redundancy Protocols such as HSRP and VRRP?", options:["To load balance across switch ports","To provide a redundant default gateway for hosts","To encrypt routing updates","To assign IP addresses dynamically"], answer:1, explain:"<strong>To provide a redundant default gateway for hosts</strong> is the purpose of FHRPs like HSRP and VRRP, which present a shared virtual gateway IP so hosts stay connected if the active router fails.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>To load balance across switch ports</b>: Port load balancing is provided by link aggregation, not by gateway redundancy protocols.</span><span class='qd'><b>To encrypt routing updates</b>: FHRPs do not encrypt traffic; their role is gateway failover.</span><span class='qd'><b>To assign IP addresses dynamically</b>: Dynamic address assignment is DHCP's function, not an FHRP function.</span>" },
{ id:"D2-017", domain:2, obj:"2.1", diff:"easy", q:"What default administrative distance does RIP use?", options:["90","110","120","170"], answer:2, explain:"<strong>120</strong> is the default administrative distance of RIP on a Cisco router.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>90</b>: An AD of 90 is internal EIGRP, not RIP.</span><span class='qd'><b>110</b>: An AD of 110 is OSPF, not RIP.</span><span class='qd'><b>170</b>: An AD of 170 is external EIGRP, not RIP.</span>" },
{ id:"D2-018", domain:2, obj:"2.1", diff:"medium", q:"Which OSPF area number is reserved as the backbone area to which all other areas must connect?", options:["Area 1","Area 10","Area 0","Area 255"], answer:2, explain:"<strong>Area 0</strong> is the reserved OSPF backbone area to which all non-backbone areas must connect, directly or via virtual links.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Area 1</b>: Area 1 is an ordinary non-backbone area that itself must attach to area 0.</span><span class='qd'><b>Area 10</b>: Area 10 is just a normal numbered area, not the reserved backbone.</span><span class='qd'><b>Area 255</b>: Area 255 is a valid area number but carries no special backbone status.</span>" },
...
{ id:"D2-043", domain:2, obj:"2.3", diff:"medium", q:"Which wireless security standard introduced Simultaneous Authentication of Equals (SAE) to replace the pre-shared key handshake?", options:["WEP","WPA","WPA2","WPA3"], answer:3, explain:"<strong>WPA3</strong> introduced Simultaneous Authentication of Equals (SAE), the Dragonfly handshake, to resist offline dictionary attacks.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>WEP</b>: WEP uses a weak RC4-based static key scheme with no SAE.</span><span class='qd'><b>WPA</b>: WPA relied on TKIP and a PSK handshake, not SAE.</span><span class='qd'><b>WPA2</b>: WPA2 uses the four-way PSK handshake that SAE was designed to replace.</span>" },
{ id:"D2-044", domain:2, obj:"2.3", diff:"hard", q:"In a wireless deployment, what is the MOST likely cause of severe throughput loss when two nearby access points are both set to 2.4 GHz channel 6?", options:["PoE overload","Co-channel interference","Native VLAN mismatch","Excessive administrative distance"], answer:1, explain:"<strong>Co-channel interference</strong> is the most likely cause because two APs on the same channel 6 must contend for identical airtime, halving effective throughput.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>PoE overload</b>: PoE limits affect whether a device powers on, not airtime contention between APs.</span><span class='qd'><b>Native VLAN mismatch</b>: A native VLAN mismatch is a wired trunk problem, not a wireless throughput cause.</span><span class='qd'><b>Excessive administrative distance</b>: AD is a routing concept and has no bearing on wireless RF throughput.</span>" },
{ id:"D2-045", domain:2, obj:"2.3", diff:"medium", q:"Which wireless component connects multiple lightweight access points and centralizes their configuration and management?", options:["Wireless LAN controller","Layer 2 switch","DHCP server","Default gateway"], answer:0, explain:"<strong>Wireless LAN controller</strong> centrally manages lightweight access points, handling their configuration, roaming, and RF coordination.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Layer 2 switch</b>: A switch forwards frames and may power APs but does not centrally configure or manage them as a WLC does.</span><span class='qd'><b>DHCP server</b>: A DHCP server assigns IP addresses and does not manage AP configuration or RF.</span><span class='qd'><b>Default gateway</b>: A gateway routes traffic off the subnet and provides no AP management role.</span>" },
...
{ id:"D2-054", domain:2, obj:"2.3", diff:"medium", q:"A technician wants the widest channel bandwidth available to a Wi-Fi 6E client. Which band must be used to obtain 160 MHz channels with minimal contention?", options:["2.4 GHz","5 GHz only","6 GHz","900 MHz"], answer:2, explain:"<strong>6 GHz</strong> must be used because Wi-Fi 6E added that band, providing abundant spectrum for many 160 MHz channels with minimal contention.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>2.4 GHz</b>: The 2.4 GHz band is too narrow to support 160 MHz channels.</span><span class='qd'><b>5 GHz only</b>: 5 GHz supports some 160 MHz channels but with more contention and DFS constraints than 6 GHz.</span><span class='qd'><b>900 MHz</b>: 900 MHz is not a Wi-Fi 6E band and offers far too little spectrum for wide channels.</span>" },
...
{ id:"D2-056", domain:2, obj:"2.3", diff:"medium", q:"Which security standard introduced Simultaneous Authentication of Equals (SAE) to replace the pre-shared key handshake?", options:["WEP","WPA","WPA2","WPA3"], answer:3, explain:"<strong>WPA3</strong> introduced Simultaneous Authentication of Equals (SAE) to replace the pre-shared key handshake and resist offline dictionary attacks.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>WEP</b>: WEP uses static RC4 keys and predates SAE entirely.</span><span class='qd'><b>WPA</b>: WPA introduced TKIP and a PSK handshake, not SAE.</span><span class='qd'><b>WPA2</b>: WPA2 uses the four-way PSK handshake that SAE was created to replace.</span>" },
{ id:"D2-057", domain:2, obj:"2.3", diff:"medium", q:"WPA2-Personal uses which encryption cipher by default?", options:["TKIP","AES-CCMP","RC4","GCMP-256"], answer:1, explain:"<strong>AES-CCMP</strong> is the default cipher mandated by WPA2.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>TKIP</b>: TKIP is the legacy WPA cipher carried over as a deprecated option, not the WPA2 default.</span><span class='qd'><b>RC4</b>: RC4 is the weak stream cipher used by WEP and TKIP, not WPA2's AES-based default.</span><span class='qd'><b>GCMP-256</b>: GCMP-256 is associated with WPA3, not the default WPA2 cipher.</span>" },
{ id:"D2-058", domain:2, obj:"2.3", diff:"easy", q:"What does SSID stand for in a wireless network?", options:["Secure Server Identification","Service Set Identifier","System Security ID","Signal Strength Indicator"], answer:1, explain:"<strong>Service Set Identifier</strong> is what SSID stands for, the human-readable name of a wireless network.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Secure Server Identification</b>: This is a fabricated expansion that does not match the 802.11 term.</span><span class='qd'><b>System Security ID</b>: This is not the meaning of SSID in wireless networking.</span><span class='qd'><b>Signal Strength Indicator</b>: Signal strength is measured by RSSI, which is a different acronym and concept.</span>" },
...
{ id:"D2-060", domain:2, obj:"2.3", diff:"medium", q:"During a predictive wireless site survey, what deliverable visually shows expected signal coverage and strength across a floor plan?", options:["Wiring diagram","Heat map","Rack elevation","Logical topology"], answer:1, explain:"<strong>Heat map</strong> is the deliverable that overlays expected signal coverage and strength onto a floor plan.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Wiring diagram</b>: A wiring diagram shows physical cable connections, not RF coverage.</span><span class='qd'><b>Rack elevation</b>: A rack elevation depicts equipment placement in a rack, not wireless coverage.</span><span class='qd'><b>Logical topology</b>: A logical topology shows device and network relationships, not signal strength across a floor.</span>" },
{ id:"D2-061", domain:2, obj:"2.3", diff:"hard", q:"A site survey reveals two adjacent APs both set to channel 6 in 2.4 GHz with overlapping coverage. Users report slow throughput. What is the MOST likely cause?", options:["Adjacent-channel interference","Co-channel interference","Cross-band leakage","Insufficient PoE budget"], answer:1, explain:"<strong>Co-channel interference</strong> is the most likely cause because both APs share channel 6 and must contend for the same airtime where coverage overlaps.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Adjacent-channel interference</b>: Adjacent-channel interference arises from partially overlapping nearby channels, not from two APs on the exact same channel.</span><span class='qd'><b>Cross-band leakage</b>: Cross-band leakage between 2.4 and 5 GHz is not occurring when both APs use the same 2.4 GHz channel.</span><span class='qd'><b>Insufficient PoE budget</b>: A PoE shortfall would prevent an AP from powering, not cause same-channel airtime contention.</span>" },
{ id:"D2-062", domain:2, obj:"2.3", diff:"medium", q:"Which authentication method does WPA3-Enterprise rely on for centralized credential validation?", options:["A static pre-shared key","802.1X with a RADIUS server","MAC address filtering","Open system authentication"], answer:1, explain:"<strong>802.1X with a RADIUS server</strong> is what WPA3-Enterprise relies on, authenticating each user through EAP against a central RADIUS server.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>A static pre-shared key</b>: A shared PSK is the Personal mode mechanism, not the per-user Enterprise approach.</span><span class='qd'><b>MAC address filtering</b>: MAC filtering is a weak, easily spoofed control, not centralized credential validation.</span><span class='qd'><b>Open system authentication</b>: Open authentication performs no credential validation at all.</span>" },
...
{ id:"D2-076", domain:2, obj:"2.4", diff:"easy", q:"In a building's cabling hierarchy, what is the term for the central space housing the primary network equipment and demarc?", options:["IDF","MDF","PDU","UPS"], answer:1, explain:"<strong>MDF</strong> (Main Distribution Frame) is the central space housing primary network equipment and the demarcation point.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>IDF</b>: An IDF is an intermediate per-floor or per-zone frame that uplinks to the MDF, not the central facility point.</span><span class='qd'><b>PDU</b>: A PDU distributes power in a rack and is not a cabling distribution space.</span><span class='qd'><b>UPS</b>: A UPS provides battery backup, not a wiring distribution location.</span>" },
{ id:"D2-077", domain:2, obj:"2.4", diff:"medium", q:"An IDF on the third floor connects back to the building's central equipment room. The central room is BEST described as the:", options:["IDF","MDF","Demarcation extension","Patch panel"], answer:1, explain:"<strong>MDF</strong> is the building's central equipment room that IDFs uplink to via backbone cabling.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>IDF</b>: The third-floor frame is the IDF; the central room it connects to is the MDF, not another IDF.</span><span class='qd'><b>Demarcation extension</b>: A demarc extension carries the provider boundary inward and is not the central distribution frame.</span><span class='qd'><b>Patch panel</b>: A patch panel terminates cables within a frame but is not the central equipment room itself.</span>" },
{ id:"D2-078", domain:2, obj:"2.4", diff:"easy", q:"What standardizes the mounting width of most network equipment racks?", options:["12 inches","19 inches","24 inches","30 inches"], answer:1, explain:"<strong>19 inches</strong> is the industry-standard mounting width for most network equipment racks.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>12 inches</b>: 12 inches is too narrow and is not a standard rack width.</span><span class='qd'><b>24 inches</b>: 24 inches is not the standard equipment mounting width, though some enclosures are wider externally.</span><span class='qd'><b>30 inches</b>: 30 inches exceeds the standard 19-inch mounting rail spacing.</span>" },
...
{ id:"D2-084", domain:2, obj:"2.4", diff:"hard", q:"Equipment requires 1500 VA and must survive a 10-minute outage. When sizing a UPS, which specification is MOST important to verify beyond VA rating?", options:["Number of network ports","Runtime at the expected load","Rack unit color","Cable category"], answer:1, explain:"<strong>Runtime at the expected load</strong> is the most important specification because a UPS must hold the actual load long enough, which VA rating alone does not guarantee.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Number of network ports</b>: A UPS is a power device; network port count is irrelevant to its sizing.</span><span class='qd'><b>Rack unit color</b>: Color has no bearing on whether the battery sustains the load for the required duration.</span><span class='qd'><b>Cable category</b>: Cable category relates to data cabling performance, not UPS battery runtime.</span>" },
{ id:"D2-085", domain:2, obj:"2.4", diff:"easy", q:"What hardware is used to terminate and organize multiple cable runs at the top of a rack for easy patching?", options:["Patch panel","UPS","Media converter","Bridge"], answer:0, explain:"<strong>Patch panel</strong> terminates permanent cable runs and presents ports for short patch cords, simplifying moves and changes.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>UPS</b>: A UPS provides battery power and does not terminate or organize cable runs.</span><span class='qd'><b>Media converter</b>: A media converter changes between media types such as fiber and copper, not bulk cable termination.</span><span class='qd'><b>Bridge</b>: A bridge forwards frames between segments and is not a passive cable-termination panel.</span>" },
{ id:"D2-086", domain:2, obj:"2.4", diff:"medium", q:"Which connector and standard would you expect on the console (management) port cable of many switches?", options:["Straight-through Ethernet","Crossover Ethernet","Rollover (rolled) cable","Loopback plug"], answer:2, explain:"<strong>Rollover (rolled) cable</strong> reverses pin order end to end and is used for serial console management of switches and routers.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Straight-through Ethernet</b>: A straight-through cable carries data between dissimilar devices, not serial console signaling.</span><span class='qd'><b>Crossover Ethernet</b>: A crossover cable links two like data devices, not a console port.</span><span class='qd'><b>Loopback plug</b>: A loopback plug tests a port by looping signals back, not for console access.</span>" },
...
{ id:"D2-088", domain:2, obj:"2.4", diff:"medium", q:"What is the maximum recommended horizontal run length for balanced twisted-pair Ethernet (Cat 5e/6)?", options:["55 meters","100 meters","185 meters","305 meters"], answer:1, explain:"<strong>100 meters</strong> is the maximum TIA channel length for balanced twisted-pair Ethernet, typically 90 m of permanent link plus 10 m of patch cords.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>55 meters</b>: 55 meters is a distance limit for certain 10GBASE-T runs on Cat 6, not the general Cat 5e/6 maximum.</span><span class='qd'><b>185 meters</b>: 185 meters is the old 10BASE2 (thinnet) coax limit, not twisted-pair Ethernet.</span><span class='qd'><b>305 meters</b>: 305 meters (1000 feet) is a cable box length, not a single Ethernet channel limit.</span>" },
{ id:"D2-089", domain:2, obj:"2.4", diff:"easy", q:"Which best practice helps prevent overheating in a densely populated equipment rack?", options:["Removing all blanking panels","Hot aisle / cold aisle airflow management","Disabling UPS units","Stacking devices with no gaps and no airflow"], answer:1, explain:"<strong>Hot aisle / cold aisle airflow management</strong> prevents overheating by keeping cold intake air separated from hot exhaust, aided by blanking panels.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Removing all blanking panels</b>: Removing blanking panels lets hot and cold air mix, worsening cooling rather than improving it.</span><span class='qd'><b>Disabling UPS units</b>: Disabling UPS units removes power protection and does nothing to manage heat.</span><span class='qd'><b>Stacking devices with no gaps and no airflow</b>: Blocking airflow traps heat and causes overheating, the opposite of best practice.</span>" },
{ id:"D2-090", domain:2, obj:"2.4", diff:"medium", q:"802.3bt Type 4 PoE (sometimes called PoE++) can deliver approximately how much power at the PSE port?", options:["15.4 W","30 W","60 W","90-100 W"], answer:3, explain:"<strong>90-100 W</strong> is the approximate power 802.3bt Type 4 (PoE++) delivers at the PSE using all four pairs, suitable for high-draw devices.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>15.4 W</b>: 15.4 W is the 802.3af figure, far below PoE++.</span><span class='qd'><b>30 W</b>: 30 W is the 802.3at (PoE+) figure, not Type 4 PoE++.</span><span class='qd'><b>60 W</b>: 60 W corresponds to 802.3bt Type 3, not the higher Type 4.</span>" },
...
{ id:"D3-057", domain:3, obj:"3.3", diff:"medium", q:"Which backup type copies all data changed since the last FULL backup and does not clear the archive bit?", options:["Incremental","Differential","Full","Mirror"], answer:1, explain:"<strong>Differential</strong> backups copy everything changed since the last full backup and leave the archive bit set, so each grows until the next full.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Incremental</b>: An incremental copies only changes since the last backup of any type and clears the archive bit.</span><span class='qd'><b>Full</b>: A full backup copies all data and clears the archive bit, not just changes since the last full.</span><span class='qd'><b>Mirror</b>: A mirror maintains an exact ongoing copy of the source and is not the archive-bit-based differential method described.</span>" },
{ id:"D3-058", domain:3, obj:"3.3", diff:"hard", q:"To restore from incremental backups after a failure, what is the MINIMUM set of backups that must be applied?", options:["The last full backup only","The last full plus the most recent incremental","The last full plus every incremental since that full","The most recent incremental only"], answer:2, explain:"<strong>The last full plus every incremental since that full</strong> is required, applied in order, because each incremental holds only the changes from the prior backup.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>The last full backup only</b>: The full alone omits all changes captured by the incrementals taken afterward.</span><span class='qd'><b>The last full plus the most recent incremental</b>: Skipping earlier incrementals loses the intermediate changes they alone contain.</span><span class='qd'><b>The most recent incremental only</b>: A single incremental has only the latest changes and cannot rebuild the full data set without the base full.</span>" },
...
{ id:"D3-071", domain:3, obj:"3.4", diff:"medium", q:"A reverse DNS lookup that resolves an IP address back to a hostname uses which record type?", options:["A","AAAA","PTR","CNAME"], answer:2, explain:"<strong>PTR</strong> (Pointer) records map an IP address back to a hostname and are the basis of reverse DNS lookups.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>A</b>: An A record maps a hostname to an IPv4 address, the forward direction, not reverse.</span><span class='qd'><b>AAAA</b>: An AAAA record maps a hostname to an IPv6 address, again forward resolution.</span><span class='qd'><b>CNAME</b>: A CNAME aliases one hostname to another and does not resolve an IP back to a name.</span>" },
{ id:"D3-072", domain:3, obj:"3.4", diff:"medium", q:"SPF, DKIM, and DMARC email authentication policies are most commonly published using which DNS record type?", options:["MX","TXT","SRV","NS"], answer:1, explain:"<strong>TXT</strong> records hold arbitrary text and are used to publish SPF, DKIM, and DMARC policies that help validate email senders.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>MX</b>: An MX record designates mail servers, not the text-based authentication policies.</span><span class='qd'><b>SRV</b>: An SRV record locates services by host and port and does not carry SPF or DMARC strings.</span><span class='qd'><b>NS</b>: An NS record delegates authority for a zone, not email authentication policy.</span>" },
{ id:"D3-073", domain:3, obj:"3.4", diff:"medium", q:"Which DNS record identifies the hostname and port of a service such as SIP or LDAP?", options:["SRV","MX","NS","SOA"], answer:0, explain:"<strong>SRV</strong> (Service) records specify the host and port for specific services, letting clients locate services like SIP, LDAP, or Active Directory.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>MX</b>: An MX record locates only mail servers and does not include port information for arbitrary services.</span><span class='qd'><b>NS</b>: An NS record names the authoritative servers for a zone, not a service host and port.</span><span class='qd'><b>SOA</b>: An SOA record holds zone-wide parameters, not the location of a specific service.</span>" },
{ id:"D3-074", domain:3, obj:"3.4", diff:"medium", q:"Which DNS record delegates a zone to a set of authoritative name servers?", options:["SOA","NS","PTR","A"], answer:1, explain:"<strong>NS</strong> (Name Server) records list the authoritative name servers for a zone and are used to delegate it.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>SOA</b>: An SOA record holds zone parameters like the primary server and serial number but does not list the full set of delegated name servers.</span><span class='qd'><b>PTR</b>: A PTR record maps an IP to a hostname for reverse DNS, not zone delegation.</span><span class='qd'><b>A</b>: An A record maps a hostname to an IPv4 address and does not delegate authority.</span>" },
...
{ id:"D3-093", domain:3, obj:"3.5", diff:"medium", q:"Why is Telnet discouraged for device management in favor of SSH?", options:["Telnet is slower at large file transfers","Telnet transmits credentials in plaintext","Telnet cannot reach remote subnets","Telnet requires a console cable"], answer:1, explain:"<strong>Telnet transmits credentials in plaintext</strong>, allowing easy interception, which is why SSH and its encrypted session are preferred.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Telnet is slower at large file transfers</b>: Telnet is not a file-transfer protocol, and speed is not the security reason it is discouraged.</span><span class='qd'><b>Telnet cannot reach remote subnets</b>: Telnet can reach routed remote subnets just like SSH; reachability is not the issue.</span><span class='qd'><b>Telnet requires a console cable</b>: Telnet is a network protocol and does not require a console cable.</span>" },
{ id:"D3-094", domain:3, obj:"3.5", diff:"hard", q:"An organization wants administrators to authenticate once at a hardened gateway, with all management sessions logged and recorded. Which design BEST fits?", options:["Direct SSH from every admin laptop to each device","A jump box that brokers and logs all administrative access","Shared local admin accounts on every switch","A captive portal on the management VLAN"], answer:1, explain:"<strong>A jump box that brokers and logs all administrative access</strong> centralizes authentication at one hardened gateway and records all management sessions, matching the requirement.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Direct SSH from every admin laptop to each device</b>: Direct connections scatter access and provide no single audited, recorded entry point.</span><span class='qd'><b>Shared local admin accounts on every switch</b>: Shared local accounts destroy accountability and central logging rather than enforcing a single audited gateway.</span><span class='qd'><b>A captive portal on the management VLAN</b>: A captive portal handles user network onboarding, not brokering and recording administrative sessions.</span>" },
{ id:"D3-095", domain:3, obj:"3.5", diff:"medium", q:"Which approach BEST keeps device management traffic separate from user data traffic?", options:["Use a dedicated out-of-band management network","Increase the DHCP lease time","Enable jumbo frames on user VLANs","Lower the routing protocol metric"], answer:0, explain:"<strong>Use a dedicated out-of-band management network</strong> best keeps management traffic separate from user data, isolating it for security and availability.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Increase the DHCP lease time</b>: Lease time affects address retention and does nothing to separate management from user traffic.</span><span class='qd'><b>Enable jumbo frames on user VLANs</b>: Jumbo frames raise MTU for throughput and do not isolate management traffic.</span><span class='qd'><b>Lower the routing protocol metric</b>: Adjusting a metric changes path preference, not the separation of management and data traffic.</span>" }
);
NETPLUS.questions.push(
{ id:"D4-001", domain:4, obj:"4.1", diff:"easy", q:"Which element of the CIA triad ensures that data has not been altered or tampered with in transit or storage?", options:["Integrity","Confidentiality","Availability","Accountability"], answer:0, explain:"<strong>Integrity</strong> ensures data remains accurate and unaltered, typically verified with hashing so any tampering in transit or storage is detected.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Confidentiality</b>: Confidentiality keeps data secret from unauthorized parties through encryption, but it does not detect whether data was changed.</span><span class='qd'><b>Availability</b>: Availability ensures systems and data are reachable when needed, not that the data is unmodified.</span><span class='qd'><b>Accountability</b>: Accountability ties actions to identities through logging, and it is not one of the three core CIA triad elements measuring data alteration.</span>" },
{ id:"D4-002", domain:4, obj:"4.1", diff:"easy", q:"Which element of the CIA triad is most directly threatened by a Distributed Denial of Service (DDoS) attack?", options:["Confidentiality","Integrity","Availability","Authentication"], answer:2, explain:"<strong>Availability</strong> is most directly attacked by a DDoS, which overwhelms a resource so legitimate users cannot reach it.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Confidentiality</b>: Confidentiality concerns unauthorized disclosure of data, which a flooding attack does not target.</span><span class='qd'><b>Integrity</b>: Integrity concerns unauthorized alteration of data, but a DDoS denies access rather than modifying content.</span><span class='qd'><b>Authentication</b>: Authentication verifies identity and is not part of the CIA triad nor the asset a flooding attack consumes.</span>" },
...
{ id:"D4-004", domain:4, obj:"4.1", diff:"medium", q:"Which AAA component is responsible for recording what a user did during a session, including login times and commands issued?", options:["Authentication","Authorization","Accounting","Association"], answer:2, explain:"<strong>Accounting</strong> tracks and logs user activity such as login times and commands issued for auditing, billing, and security review.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Authentication</b>: Authentication only verifies who the user is at login and does not record what they do afterward.</span><span class='qd'><b>Authorization</b>: Authorization decides what an authenticated user is permitted to do, not what they actually did.</span><span class='qd'><b>Association</b>: Association is the 802.11 process of a wireless client joining an access point, unrelated to AAA logging.</span>" },
{ id:"D4-005", domain:4, obj:"4.1", diff:"medium", q:"Which port and transport protocol does RADIUS use for authentication messages?", options:["UDP port 1812","TCP port 49","TCP port 1812","UDP port 49"], answer:0, explain:"<strong>UDP port 1812</strong> is the standard RADIUS authentication port, with UDP 1813 used for accounting.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>TCP port 49</b>: TCP 49 is TACACS+, not RADIUS, and RADIUS does not use TCP for these messages.</span><span class='qd'><b>TCP port 1812</b>: The port number is correct but RADIUS uses UDP, not TCP, as its transport.</span><span class='qd'><b>UDP port 49</b>: Port 49 belongs to TACACS+ over TCP, so neither the port nor pairing fits RADIUS.</span>" },
{ id:"D4-006", domain:4, obj:"4.1", diff:"medium", q:"Which port and transport protocol does TACACS+ use?", options:["TCP port 49","UDP port 1812","UDP port 49","TCP port 1813"], answer:0, explain:"<strong>TCP port 49</strong> is used by TACACS+, which encrypts the entire packet payload unlike RADIUS.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>UDP port 1812</b>: That is RADIUS authentication, which uses UDP rather than the TCP transport TACACS+ requires.</span><span class='qd'><b>UDP port 49</b>: The port number is correct but TACACS+ runs over TCP, not UDP.</span><span class='qd'><b>TCP port 1813</b>: Port 1813 is RADIUS accounting over UDP, not a TACACS+ port.</span>" },
{ id:"D4-007", domain:4, obj:"4.1", diff:"hard", q:"A network engineer must choose an AAA protocol that encrypts the entire packet body and separates authentication, authorization, and accounting functions. Which is the BEST choice?", options:["Kerberos","RADIUS","LDAP","TACACS+"], answer:3, explain:"<strong>TACACS+</strong> encrypts the whole packet body and decouples authentication, authorization, and accounting, making it ideal for granular device administration.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Kerberos</b>: Kerberos is a ticket-based authentication protocol for SSO, not an AAA protocol that separates authorization and accounting per command.</span><span class='qd'><b>RADIUS</b>: RADIUS only encrypts the password field and combines authentication with authorization, so it cannot separate the functions as required.</span><span class='qd'><b>LDAP</b>: LDAP is a directory access protocol for querying user objects, not an AAA protocol that encrypts and decouples the three functions.</span>" },
{ id:"D4-008", domain:4, obj:"4.1", diff:"medium", q:"Which standard provides port-based network access control, often requiring authentication before a switch port forwards general traffic?", options:["802.11ac","802.1Q","802.1X","802.3af"], answer:2, explain:"<strong>802.1X</strong> is the IEEE port-based network access control standard that authenticates devices before a port forwards general traffic.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>802.11ac</b>: 802.11ac is a Wi-Fi physical layer standard for wireless throughput, not an access control framework.</span><span class='qd'><b>802.1Q</b>: 802.1Q defines VLAN tagging on trunk links, not authentication of devices on a port.</span><span class='qd'><b>802.3af</b>: 802.3af is the Power over Ethernet standard delivering power over copper, unrelated to access control.</span>" },
{ id:"D4-009", domain:4, obj:"4.1", diff:"medium", q:"In an 802.1X deployment, which role does the end-user device run that requests access to the network?", options:["Supplicant","Authenticator","Authentication server","RADIUS proxy"], answer:0, explain:"<strong>Supplicant</strong> is the client-side software that submits credentials to the authenticator requesting network access.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Authenticator</b>: The authenticator is the switch or AP that relays credentials, not the end-user device requesting access.</span><span class='qd'><b>Authentication server</b>: The authentication server (usually RADIUS) validates credentials and is not the requesting client.</span><span class='qd'><b>RADIUS proxy</b>: A RADIUS proxy forwards authentication requests between servers and is not the end device seeking access.</span>" },
{ id:"D4-010", domain:4, obj:"4.1", diff:"hard", q:"In 802.1X terminology, which component typically acts as the authenticator?", options:["The RADIUS server","The end-user laptop","The switch or wireless access point","The certificate authority"], answer:2, explain:"<strong>The switch or wireless access point</strong> acts as the authenticator, relaying credentials between the supplicant and the authentication server.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>The RADIUS server</b>: The RADIUS server is the authentication server that makes the access decision, not the authenticator that brokers it.</span><span class='qd'><b>The end-user laptop</b>: The end-user laptop runs the supplicant requesting access, not the authenticator.</span><span class='qd'><b>The certificate authority</b>: A CA issues and signs certificates used in EAP-TLS but does not gate the port as the authenticator.</span>" },
...
{ id:"D4-012", domain:4, obj:"4.1", diff:"hard", q:"In a zero trust architecture, the policy enforcement point (PEP) and policy decision point (PDP) together form which conceptual plane?", options:["The control plane","The data plane","The management plane","The forwarding plane"], answer:0, explain:"<strong>The control plane</strong> is formed by the policy decision point and policy enforcement point, which together decide and enforce access to data plane resources.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>The data plane</b>: The data plane carries the actual user traffic to resources after the control plane authorizes it, not the decision-making layer.</span><span class='qd'><b>The management plane</b>: The management plane handles device administration and configuration, not zero trust access decisions.</span><span class='qd'><b>The forwarding plane</b>: The forwarding plane is another name for the data plane that moves packets, not where PDP and PEP reside.</span>" },
{ id:"D4-013", domain:4, obj:"4.1", diff:"easy", q:"Which network design concept places public-facing servers in a separate buffer zone between the internet and the internal LAN?", options:["DMZ (screened subnet)","VLAN trunk","Loopback","Broadcast domain"], answer:0, explain:"<strong>DMZ (screened subnet)</strong> places public-facing servers in a buffer zone so a compromise does not directly expose the internal LAN.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>VLAN trunk</b>: A VLAN trunk carries multiple VLANs over one link, not a security buffer zone for public servers.</span><span class='qd'><b>Loopback</b>: A loopback is a virtual interface on a device used for testing or stable addressing, not a network design zone.</span><span class='qd'><b>Broadcast domain</b>: A broadcast domain is the scope reached by broadcast frames, not an isolated zone for internet-facing services.</span>" },
{ id:"D4-014", domain:4, obj:"4.1", diff:"medium", q:"What is the primary security benefit of network segmentation?", options:["It limits the lateral movement of an attacker","It increases overall bandwidth","It eliminates the need for firewalls","It speeds up DNS resolution"], answer:0, explain:"<strong>It limits the lateral movement of an attacker</strong> because segmentation divides the network so a breach in one segment cannot easily spread to others.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>It increases overall bandwidth</b>: Segmentation can reduce broadcast traffic but its primary purpose is security containment, not raw bandwidth gains.</span><span class='qd'><b>It eliminates the need for firewalls</b>: Segmentation often relies on firewalls or ACLs to filter inter-segment traffic, so it does not remove that need.</span><span class='qd'><b>It speeds up DNS resolution</b>: DNS resolution speed depends on resolvers and caching, which segmentation does not affect.</span>" },
...
{ id:"D4-016", domain:4, obj:"4.1", diff:"easy", q:"Which factor type is represented by a fingerprint scan in multifactor authentication?", options:["Something you know","Something you have","Something you are","Somewhere you are"], answer:2, explain:"<strong>Something you are</strong> covers inherence factors like biometrics, including a fingerprint scan.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Something you know</b>: Knowledge factors are passwords or PINs, not physical biometric traits.</span><span class='qd'><b>Something you have</b>: Possession factors are tokens, smart cards, or phones, not an inherent body characteristic.</span><span class='qd'><b>Somewhere you are</b>: Location factors use GPS or network position, not a fingerprint.</span>" },
{ id:"D4-017", domain:4, obj:"4.1", diff:"easy", q:"A hardware token that generates a rotating one-time code represents which authentication factor?", options:["Something you have","Something you know","Something you are","Something you do"], answer:0, explain:"<strong>Something you have</strong> is the possession factor represented by a hardware token that generates a rotating one-time code.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Something you know</b>: Knowledge factors are memorized secrets like passwords, not a physical token device.</span><span class='qd'><b>Something you are</b>: Inherence factors are biometrics such as fingerprints, not a possessed object.</span><span class='qd'><b>Something you do</b>: Behavioral factors capture patterns like gait or signature dynamics, not holding a token.</span>" },
{ id:"D4-018", domain:4, obj:"4.1", diff:"hard", q:"An organization wants strong authentication that resists phishing of one-time codes. Which factor combination provides the MOST phishing-resistant MFA?", options:["Password plus SMS code","Password plus email code","Password plus FIDO2 security key","Two different passwords"], answer:2, explain:"<strong>Password plus FIDO2 security key</strong> uses origin-bound public-key cryptography, resisting phishing far better than codes that can be relayed.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Password plus SMS code</b>: SMS codes can be phished, SIM-swapped, or intercepted, making them weakly phishing-resistant.</span><span class='qd'><b>Password plus email code</b>: Email codes can be captured if the inbox is compromised or relayed through a fake site, so they are phishable.</span><span class='qd'><b>Two different passwords</b>: Two passwords are both knowledge factors, so they are not true MFA and remain fully phishable.</span>" },
...
{ id:"D4-047", domain:4, obj:"4.2", diff:"easy", q:"Malware that encrypts a victim's files and demands payment for the decryption key is known as what?", options:["Spyware","Ransomware","Adware","Rootkit"], answer:1, explain:"<strong>Ransomware</strong> encrypts a victim's files and demands payment for the decryption key, threatening data availability.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Spyware</b>: Spyware covertly gathers information about a user, not encrypting files for ransom.</span><span class='qd'><b>Adware</b>: Adware displays unwanted advertisements, not extorting payment for decryption.</span><span class='qd'><b>Rootkit</b>: A rootkit hides malicious presence and maintains privileged access, not encrypting data for ransom.</span>" },
{ id:"D4-048", domain:4, obj:"4.2", diff:"easy", q:"Looking through an organization's discarded trash to find sensitive information is known as what?", options:["Tailgating","Pharming","Dumpster diving","Vishing"], answer:2, explain:"<strong>Dumpster diving</strong> recovers improperly discarded documents or media containing useful information for an attacker.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Tailgating</b>: Tailgating is following an authorized person through a secure door, not searching discarded trash.</span><span class='qd'><b>Pharming</b>: Pharming redirects users to fraudulent sites via DNS manipulation, not physical scavenging.</span><span class='qd'><b>Vishing</b>: Vishing uses deceptive voice calls, not retrieving information from the trash.</span>" },
{ id:"D4-049", domain:4, obj:"4.3", diff:"easy", q:"Which switch feature limits the number of MAC addresses learned on a port and can shut the port down if violated?", options:["DHCP snooping","BPDU guard","Dynamic ARP Inspection","Port security"], answer:3, explain:"<strong>Port security</strong> limits the MAC addresses learned on a port and can shut the port down when the limit is violated.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>DHCP snooping</b>: DHCP snooping blocks rogue DHCP offers from untrusted ports, not limiting MAC addresses per port.</span><span class='qd'><b>BPDU guard</b>: BPDU guard disables a port that receives a BPDU to stop rogue switches, not enforcing a MAC count.</span><span class='qd'><b>Dynamic ARP Inspection</b>: DAI validates ARP packets against trusted bindings, not capping learned MAC addresses.</span>" },
{ id:"D4-050", domain:4, obj:"4.3", diff:"medium", q:"Which mitigation directly counters MAC flooding attacks against a switch?", options:["DNS filtering","Port security with a MAC limit","Disabling SNMP","BPDU guard"], answer:1, explain:"<strong>Port security with a MAC limit</strong> caps the number of MACs per port, preventing the CAM table overflow that MAC flooding relies on.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>DNS filtering</b>: DNS filtering blocks resolution of malicious domains, irrelevant to a Layer 2 CAM table flood.</span><span class='qd'><b>Disabling SNMP</b>: Disabling SNMP reduces management exposure but does nothing to stop bogus MAC addresses flooding a port.</span><span class='qd'><b>BPDU guard</b>: BPDU guard protects against rogue switches sending BPDUs, not against MAC address table exhaustion.</span>" },
{ id:"D4-051", domain:4, obj:"4.3", diff:"medium", q:"Which feature builds a trusted binding table and drops DHCP server responses from untrusted ports, stopping rogue DHCP servers?", options:["Port mirroring","Spanning Tree","DHCP snooping","NAT"], answer:2, explain:"<strong>DHCP snooping</strong> marks ports as trusted or untrusted and blocks DHCP server responses from untrusted ports, defeating rogue DHCP servers.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Port mirroring</b>: Port mirroring copies traffic to a monitoring port for analysis, not filtering DHCP offers.</span><span class='qd'><b>Spanning Tree</b>: Spanning Tree prevents Layer 2 loops, not unauthorized DHCP responses.</span><span class='qd'><b>NAT</b>: NAT translates addresses between networks, unrelated to blocking rogue DHCP servers on a LAN.</span>" },
{ id:"D4-052", domain:4, obj:"4.3", diff:"hard", q:"Dynamic ARP Inspection (DAI) relies on which other feature's database to validate ARP packets?", options:["The STP topology table","The routing table","The NAT translation table","The DHCP snooping binding table"], answer:3, explain:"<strong>The DHCP snooping binding table</strong> is what DAI uses to validate ARP packets, dropping invalid IP-to-MAC mappings.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>The STP topology table</b>: The STP topology reflects loop-free paths, not the IP-to-MAC bindings DAI checks.</span><span class='qd'><b>The routing table</b>: The routing table maps destinations to next hops at Layer 3, not validated ARP bindings.</span><span class='qd'><b>The NAT translation table</b>: The NAT table tracks address translations for outbound sessions, not ARP-to-binding validation.</span>" },
{ id:"D4-053", domain:4, obj:"4.3", diff:"medium", q:"Which mitigation BEST defends against ARP spoofing on a managed switch?", options:["BPDU guard","Dynamic ARP Inspection","Storm control","Port mirroring"], answer:1, explain:"<strong>Dynamic ARP Inspection</strong> validates ARP packets against trusted bindings, blocking the forged ARP replies used in spoofing.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>BPDU guard</b>: BPDU guard disables ports receiving BPDUs to stop rogue switches, not forged ARP replies.</span><span class='qd'><b>Storm control</b>: Storm control limits broadcast or multicast flooding rates, not validating ARP bindings.</span><span class='qd'><b>Port mirroring</b>: Port mirroring copies traffic for monitoring and does not block spoofed ARP packets.</span>" },
{ id:"D4-054", domain:4, obj:"4.3", diff:"medium", q:"Which feature should be enabled on access ports to immediately disable a port if it receives a BPDU, preventing rogue switches and STP manipulation?", options:["DHCP snooping","Root guard only on trunks","BPDU guard","Port mirroring"], answer:2, explain:"<strong>BPDU guard</strong> err-disables an access port that unexpectedly receives a BPDU, protecting against rogue switches and STP manipulation.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>DHCP snooping</b>: DHCP snooping filters rogue DHCP offers, not BPDUs on access ports.</span><span class='qd'><b>Root guard only on trunks</b>: Root guard prevents a port from becoming root but applies to designated links and does not err-disable an access port on any received BPDU as required.</span><span class='qd'><b>Port mirroring</b>: Port mirroring copies traffic for analysis and takes no action on received BPDUs.</span>" },
{ id:"D4-055", domain:4, obj:"4.3", diff:"hard", q:"To prevent switch-spoofing VLAN hopping, which configuration is the MOST effective?", options:["Enable BPDU guard on trunks","Increase the MTU","Enable DHCP snooping","Disable DTP and set ports to access mode (nonnegotiate)"], answer:3, explain:"<strong>Disable DTP and set ports to access mode (nonnegotiate)</strong> prevents an attacker from negotiating a trunk and is most effective against switch spoofing.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Enable BPDU guard on trunks</b>: BPDU guard protects access ports from rogue switches and does not stop DTP trunk negotiation.</span><span class='qd'><b>Increase the MTU</b>: MTU size affects frame payload, with no bearing on trunk negotiation or VLAN hopping.</span><span class='qd'><b>Enable DHCP snooping</b>: DHCP snooping blocks rogue DHCP traffic, not the DTP-based trunk an attacker negotiates.</span>" },
...
NETPLUS.questions.push(
  ...
  { id:"D5-007", domain:5, obj:"5.1", diff:"medium", q:"A user reports that they cannot access a shared drive. What should the technician do FIRST?", options:["Reboot the file server","Gather information and question the user about the issue","Replace the user's network cable","Escalate to the storage team"], answer:1, explain:"<strong>Gather information and question the user about the issue</strong> is the first step, since identifying the problem must precede any corrective action.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Reboot the file server</b>: Rebooting before understanding the issue is an untested action that could disrupt many other users unnecessarily.</span><span class='qd'><b>Replace the user's network cable</b>: Swapping hardware assumes a physical cause that has not been established through information gathering.</span><span class='qd'><b>Escalate to the storage team</b>: Escalation comes only after the technician has identified the problem and determined it exceeds their scope.</span>" },
  { id:"D5-008", domain:5, obj:"5.1", diff:"hard", q:"During problem identification, a technician learns the user installed new software just before the outage. This BEST relates to which sub-task?", options:["Approaching multiple problems individually","Determining if anything has changed","Duplicating the problem","Establishing a plan of action"], answer:1, explain:"<strong>Determining if anything has changed</strong> is a key sub-task of identifying the problem, and recently installed software is a classic change that points to the root cause.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Approaching multiple problems individually</b>: This sub-task applies when several distinct issues exist, not to noting a single recent change.</span><span class='qd'><b>Duplicating the problem</b>: Duplicating means reproducing the symptom on demand, which is different from discovering what changed.</span><span class='qd'><b>Establishing a plan of action</b>: A plan of action is a later step built after the cause is confirmed, not part of initial identification.</span>" },
  { id:"D5-009", domain:5, obj:"5.1", diff:"medium", q:"Why is it important to question the obvious when establishing a theory of probable cause?", options:["It guarantees the problem is hardware-related","Simple causes (e.g., unplugged cable, disabled NIC) are common and quickly ruled out","It eliminates the need to test the theory","It replaces the need to document findings"], answer:1, explain:"<strong>Simple causes (e.g., unplugged cable, disabled NIC) are common and quickly ruled out</strong>, so questioning the obvious saves time before chasing complex theories.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>It guarantees the problem is hardware-related</b>: Obvious causes can be software or configuration related too, so nothing about hardware is guaranteed.</span><span class='qd'><b>It eliminates the need to test the theory</b>: Every theory, even an obvious one, still must be tested to confirm the cause.</span><span class='qd'><b>It replaces the need to document findings</b>: Documentation remains a required final step regardless of how simple the cause was.</span>" },
...
NETPLUS.questions.push(
  ...
  { id:"D5-071", domain:5, obj:"5.3", diff:"medium", q:"A DHCP relay (IP helper) is missing on a router interface. What happens to clients on that subnet?", options:["They receive duplicate IPs","They cannot reach the DHCP server on another subnet and fall back to APIPA","Their DNS suffix is wrong","They get the lease but no gateway"], answer:1, explain:"Without an IP helper/relay, DHCP broadcasts do not cross the router, so clients on the remote subnet get no lease and self-assign APIPA.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>They receive duplicate IPs</b>: A missing relay means no leases are issued at all, so there is nothing to duplicate.</span><span class='qd'><b>Their DNS suffix is wrong</b>: The DNS suffix is a lease option that is only delivered once DHCP succeeds, which it cannot here.</span><span class='qd'><b>They get the lease but no gateway</b>: Without a relay the broadcast never reaches the server, so clients get no lease whatsoever, not a partial one.</span>" },
  { id:"D5-072", domain:5, obj:"5.3", diff:"medium", q:"Which DNS record type maps a hostname to an IPv6 address?", options:["A","AAAA","MX","PTR"], answer:1, explain:"An <code class='mono'>AAAA</code> record resolves a hostname to a 128-bit IPv6 address.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>A</b>: An A record maps a hostname to a 32-bit IPv4 address, not IPv6.</span><span class='qd'><b>MX</b>: An MX record identifies a domain's mail exchanger, not a host address.</span><span class='qd'><b>PTR</b>: A PTR record performs reverse lookups, mapping an IP back to a name rather than a name to an IPv6 address.</span>" },
  { id:"D5-073", domain:5, obj:"5.3", diff:"hard", q:"Email delivery to a domain fails while web browsing works fine. Which DNS record should you verify FIRST?", options:["A record","CNAME record","MX record","TXT record"], answer:2, explain:"Mail routing depends on the <code class='mono'>MX</code> record, so a missing or wrong MX breaks email while leaving web (A/CNAME) resolution intact.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>A record</b>: The A record maps the web host's name to an IPv4 address, and web browsing already works, so it is fine.</span><span class='qd'><b>CNAME record</b>: A CNAME is an alias to another name and governs web aliases, not the mail-routing decision that MX controls.</span><span class='qd'><b>TXT record</b>: TXT records carry SPF/DKIM and other text data that affect mail authentication, but the actual delivery target is set by MX.</span>" },
  ...
  { id:"D5-079", domain:5, obj:"5.4", diff:"medium", q:"An interface shows a steadily rising count of CRC errors. What is the most likely cause?", options:["Incorrect default gateway","A bad cable or electromagnetic interference","An expired TLS certificate","A DNS misconfiguration"], answer:1, explain:"CRC and frame errors point to data corrupted in transit, which is a physical-layer problem such as a damaged cable, bad connector, or electromagnetic interference.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>Incorrect default gateway</b>: A wrong gateway is a Layer 3 routing misconfiguration and does not corrupt frames into CRC errors.</span><span class='qd'><b>An expired TLS certificate</b>: A certificate problem is an application-layer trust issue and has no effect on physical-layer error counters.</span><span class='qd'><b>A DNS misconfiguration</b>: DNS affects name resolution, not the integrity of bits on the wire that CRC checks.</span>" },
  { id:"D5-080", domain:5, obj:"5.4", diff:"hard", q:"A 1 Gbps link is mysteriously slow and the interface shows many late collisions and runts. What is the MOST likely cause?", options:["MTU mismatch","Duplex mismatch between the two ends","Exhausted DHCP scope","Wrong DNS server"], answer:1, explain:"Late collisions and runts on a modern link are classic signs of a duplex mismatch, where one side runs half duplex and the other full.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>MTU mismatch</b>: An MTU mismatch produces oversized/dropped frames or fragmentation, not late collisions and runts.</span><span class='qd'><b>Exhausted DHCP scope</b>: A drained DHCP pool prevents address assignment but does not generate collision and runt counters on an established link.</span><span class='qd'><b>Wrong DNS server</b>: A bad DNS server breaks name resolution and has no effect on Layer 1/2 collision statistics.</span>" },
  ...
  { id:"D5-111", domain:5, obj:"5.3", diff:"medium", q:"Which command on Windows shows all active connections and listening ports to confirm a service is bound?", options:["netstat -an","arp -a","tracert","ipconfig /all"], answer:0, explain:"<code class='mono'>netstat -an</code> lists active connections and all listening sockets numerically, so you can verify a service is bound and listening.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>arp -a</b>: arp -a shows IP-to-MAC mappings, not which TCP/UDP ports a service is listening on.</span><span class='qd'><b>tracert</b>: tracert traces the routed path to a destination and reveals nothing about local listening ports.</span><span class='qd'><b>ipconfig /all</b>: ipconfig /all displays interface configuration, not active connections or listening sockets.</span>" },
  { id:"D5-112", domain:5, obj:"5.3", diff:"medium", q:"A user can resolve external names but not internal ones. Which is the most likely cause?", options:["The client is pointed at a public DNS server instead of the internal one","The default gateway is wrong","The cable is bad","The certificate expired"], answer:0, explain:"Pointing at a public resolver returns external records but cannot see the internal zones, so internal names fail while external ones resolve.<br><span class='qwhy'>Why the other options are wrong:</span><span class='qd'><b>The default gateway is wrong</b>: A bad gateway would break reachability broadly, not selectively allow external name resolution while blocking internal names.</span><span class='qd'><b>The cable is bad</b>: A faulty cable causes link errors or loss of all connectivity, not a clean split between resolving external and internal names.</span><span class='qd'><b>The certificate expired</b>: An expired certificate produces TLS trust warnings, not a failure to resolve internal hostnames.</span>" },
...
{label:"Reason to keep 2.4 GHz at 20 MHz",hint:"Tradeoff",options:["Higher peak speed","Preserves the 1/6/11 non-overlap plan","Better security","Longer battery life only"],answer:1,explain:"A 40 MHz channel on 2.4 GHz consumes two of the three usable channels, making non-overlapping reuse impossible."}
],
...
fields:[
{label:"Primary band for capacity",hint:"Most clean channels",options:["2.4 GHz","5 GHz","900 MHz","Bluetooth band"],answer:1,explain:"5 GHz offers many non-overlapping channels and is supported by virtually all modern clients, making it the workhorse for capacity."},
{label:"Band for newest 6E clients",hint:"Widest open spectrum",options:["2.4 GHz","5 GHz","6 GHz","60 GHz"],answer:2,explain:"6 GHz (Wi-Fi 6E) adds large amounts of fresh, interference-free spectrum for capable clients."},
{label:"Keep 2.4 GHz enabled for",hint:"Legacy reach",options:["Highest throughput","Legacy and long-range IoT devices","RADIUS traffic","DHCP only"],answer:1,explain:"2.4 GHz has better range and wall penetration and supports older/IoT clients, so it is kept but not used for high-capacity needs."},
...
{label:"Why WPA2-PSK TKIP was a problem",hint:"Two weaknesses",options:["Too fast","Weak cipher and vulnerable to offline attacks","Needs a RADIUS server","Only works on 6 GHz"],answer:1,explain:"TKIP is deprecated and WPA2-PSK is susceptible to offline dictionary attacks once the handshake is captured."}
],
...
fields:[
{label:"Correct security mode",hint:"Per-user auth",options:["WPA3-Personal","WPA3-Enterprise","WPA2-PSK","Open with portal"],answer:1,explain:"WPA3-Enterprise uses 802.1X to authenticate each user individually via a RADIUS server, unlike a single PSK."},
{label:"EAP method for client+server certs",hint:"Mutual certificates",options:["EAP-TLS","EAP-MD5","PAP","CHAP"],answer:0,explain:"EAP-TLS provides mutual certificate authentication (both client and server present certs), the strongest common EAP method."},
{label:"Standard RADIUS authentication port",hint:"Modern assigned port",options:["1645","1812","389","3389"],answer:1,explain:"The IANA-assigned RADIUS authentication port is UDP 1812 (1813 for accounting). 1645/1646 are legacy ports."},
{label:"Role of the RADIUS server",hint:"AAA",options:["Assigns IP addresses","Authenticates users and authorizes access","Provides DNS","Encrypts the air interface only"],answer:1,explain:"RADIUS performs Authentication, Authorization, and Accounting for the 802.1X supplicants connecting to the WLAN."}
],
...
fields:[
{label:"Fix for AP-B",hint:"Different non-DFS channel",options:["Keep 36","Change to 40 (or another distinct channel)","Change to 36 again","Move to 2.4 GHz channel 1"],answer:1,explain:"Two adjacent APs on the same channel cause co-channel interference (they share airtime). Assign AP-B a distinct channel such as 40."},
...
{label:"Channel reuse principle",hint:"Spatial planning",options:["Same channel everywhere","Repeat channels only where cells do not overlap","Random channels","One channel for the whole site"],answer:1,explain:"Channels should be reused only between cells that are far enough apart not to hear each other, maximizing capacity."},
{label:"Best width here to keep channels available",hint:"More cells need more channels",options:["160 MHz","80 MHz","40 MHz","Single 20 MHz only"],answer:2,explain:"40 MHz balances throughput with having enough distinct 5 GHz channels to give each adjacent AP its own, avoiding co-channel overlap."}
],
...
{label:"Best width for a dense multi-AP site",hint:"Need reuse",options:["160 MHz","80 MHz","20 or 40 MHz","320 MHz"],answer:2,explain:"In dense deployments, narrower channels (20/40 MHz) provide more channels for reuse and reduce co-channel interference."},
{label:"When 160 MHz is appropriate",hint:"Isolated, few APs",options:["Crowded apartment building","A single isolated AP needing max speed","Outdoor mesh of many APs","2.4 GHz only"],answer:1,explain:"160 MHz suits low-density environments with few APs where there is no competition for the spectrum."},
{label:"Risk of 160 MHz in a dense site",hint:"Overlap",options:["Better roaming","Severe channel overlap and co-channel interference","Stronger encryption","Lower latency always"],answer:1,explain:"With so few 160 MHz channels, neighboring APs are forced to overlap, causing interference and reduced aggregate capacity."}
],
...
fields:[
{label:"Guest network protection",hint:"WPA3 enhancement for open nets",options:["WEP","Opportunistic Wireless Encryption (OWE)","TKIP","No encryption ever"],answer:1,explain:"OWE (Enhanced Open) encrypts traffic on an open SSID without a passphrase, protecting guests while keeping the portal experience."},
...
{label:"Keep guests off the staff VLAN by",hint:"Segmentation",options:["Same VLAN for both","VLAN/network segmentation and client isolation","Disabling DHCP","Using one SSID"],answer:1,explain:"Mapping each SSID to its own VLAN and isolating clients prevents guests from reaching staff resources."},
{label:"EAP method for staff with passwords (no certs)",hint:"Tunneled password",options:["PEAP (MSCHAPv2)","EAP-MD5","Open","PAP only"],answer:0,explain:"PEAP wraps MSCHAPv2 in a TLS tunnel, allowing username/password auth when client certificates are not deployed."}
],
...
{label:"Reassign AP-4 to",hint:"Stay in valid set",options:["Channel 8","Channel 7","Channel 1 (or another 1/6/11 value)","Channel 9"],answer:2,explain:"AP-4 must also use 1/6/11. Picking 1 (far from AP-3 on 6 and AP-5 on 11) avoids co-channel and overlap."},
{label:"Why overlapping channels hurt",hint:"Adjacent-channel interference",options:["They increase range","They cause adjacent-channel interference and corruption","They improve security","They speed up roaming"],answer:1,explain:"Overlapping channels bleed energy into each other, creating adjacent-channel interference that corrupts frames and forces retransmits."},
{label:"Only valid non-overlap channels on 2.4 GHz",hint:"US/most regions",options:["1, 6, 11","1, 5, 9","2, 7, 12","1, 4, 8, 11"],answer:0,explain:"In the 2.4 GHz band, channels 1, 6, and 11 are the only set of three that do not overlap."}
],
...
{label:"Purpose of the shared secret",hint:"AP-to-RADIUS",options:["Encrypts client Wi-Fi","Authenticates the AP (NAS) to the RADIUS server","Sets the SSID","Defines the VLAN"],answer:1,explain:"The shared secret is configured on both the AP and RADIUS server so they can trust and protect RADIUS messages between them."},
{label:"EAP method for full certificate auth",hint:"Both ends present certs",options:["EAP-TLS","EAP-MD5","PAP","LEAP"],answer:0,explain:"EAP-TLS uses certificates on both supplicant and server, providing the strongest mutual authentication."}
],
...
{label:"Feature for seamless aisle roaming",hint:"802.11 fast transition",options:["802.11r fast roaming","DHCP snooping","STP","Port mirroring"],answer:0,explain:"802.11r (Fast BSS Transition) speeds up re-authentication as scanners roam between APs, preventing session drops."},
{label:"Security mode if scanners support it",hint:"Modern PSK",options:["WEP","WPA3-Personal (SAE)","Open","WPA-TKIP"],answer:1,explain:"WPA3-Personal (SAE) gives strong protection with a shared key suitable for many headless scanner devices."}
],
...
fields:[
{label:"What DFS requires of the AP",hint:"Radar detection",options:["Higher power always","Detect radar and vacate the channel","Disable encryption","Use 2.4 GHz"],answer:1,explain:"Dynamic Frequency Selection requires the AP to detect radar and move off the channel to protect radar systems."},
...
{label:"Benefit of using DFS channels elsewhere",hint:"Capacity",options:["More available 5 GHz channels for reuse","Stronger encryption","Longer range","Lower latency guaranteed"],answer:0,explain:"Away from radar, DFS channels add many usable 5 GHz channels, improving capacity and channel reuse."}
],
...
fields:[
{label:"Mode allowing both WPA2 and WPA3 clients",hint:"Backward compatible",options:["WPA3-only","WPA3 transition (mixed) mode","WEP","Open"],answer:1,explain:"WPA3 transition mode advertises both WPA2-PSK and WPA3-SAE so legacy and new clients can join the same SSID."},
...
{label:"End-state once legacy devices retire",hint:"Final config",options:["WPA3-only (SAE)","WEP","Open","WPA2-only"],answer:0,explain:"After legacy clients are gone, switch to WPA3-only for the strongest security and to remove the transition-mode weaknesses."},
{label:"Cipher required for both",hint:"Common modern cipher",options:["TKIP","AES-CCMP","RC4","WEP-104"],answer:1,explain:"AES-CCMP is the shared secure cipher; TKIP/WEP must be disabled even in transition mode."}
],
...
fields:[
{label:"Mandatory security on 6 GHz",hint:"No legacy allowed",options:["WPA2-PSK","WPA3 (SAE or Enterprise)","WEP","Open with no encryption"],answer:1,explain:"The 6 GHz band mandates WPA3; WPA2 and older are prohibited, so it is secure by design."},
...
{label:"Advantage of 6 GHz spectrum",hint:"Cleaner air",options:["Best wall penetration","Lots of fresh channels with little legacy interference","Longest range","Works on all old clients"],answer:1,explain:"6 GHz provides abundant wide channels and is free of legacy 802.11 traffic, boosting capacity for capable clients."},
{label:"Why keep 5 GHz alongside 6 GHz",hint:"Client support",options:["6 GHz is slower","Many existing clients are not 6E-capable","6 GHz lacks security","To run WEP"],answer:1,explain:"Only Wi-Fi 6E/7 clients use 6 GHz, so 5 GHz remains necessary for the large installed base of devices."}
],
...
fields:[
{label:"Problem with 80 MHz on 2.4 GHz",hint:"Band is too small",options:["It is fine","2.4 GHz cannot fit 80 MHz without massive overlap","It improves range","It boosts security"],answer:1,explain:"The entire 2.4 GHz band only spans about three 20 MHz channels; an 80 MHz channel overlaps everything and is not supported in practice."},
{label:"Correct width for 2.4 GHz",hint:"Default",options:["80 MHz","40 MHz","20 MHz","160 MHz"],answer:2,explain:"Set 20 MHz so the AP fits cleanly into the 1/6/11 plan and stops overlapping neighbors."},
{label:"Keep the channel at",hint:"Already valid",options:["Channel 6","Channel 3","Channel 8","Channel 13"],answer:0,explain:"Channel 6 is a valid non-overlapping channel; only the width needs to change to 20 MHz."},
{label:"Expected result after the fix",hint:"Interference",options:["More interference","Reduced interference and stable throughput","Loss of all clients","No change"],answer:1,explain:"Narrowing to 20 MHz removes the overlap with neighbors on 1/6/11, reducing interference and stabilizing performance."}
],
...
fields:[
{label:"EAP method for password-only auth",hint:"Server cert, no client cert",options:["EAP-TLS","PEAP (MSCHAPv2)","EAP-MD5","PAP"],answer:1,explain:"PEAP builds a TLS tunnel using the server certificate, then carries MSCHAPv2 username/password inside, ideal when clients lack certificates."},
...
{label:"Why a server certificate is still needed",hint:"Validate the server",options:["To encrypt the SSID name","So clients can validate the RADIUS server and protect credentials in the tunnel","To assign IPs","It is optional"],answer:1,explain:"The server cert lets supplicants verify they are talking to the real RADIUS server, preventing credential theft via rogue servers."},
{label:"RADIUS authentication port",hint:"Standard UDP",options:["1812","1645","1813","636"],answer:0,explain:"UDP 1812 is the standard RADIUS authentication port the AP forwards EAP messages to."},
{label:"Backend the RADIUS server checks",hint:"Identity store",options:["DHCP scope","Active Directory / identity store","DNS zone","NTP server"],answer:1,explain:"RADIUS validates the username/password against the directory (e.g., Active Directory) before authorizing the student."}
],
