/* ============================================================================
   network+  ::  flashEngine.js  —  Rapid Recall Flashcards
   ...
   - Cards live in lazy-loaded per-domain modules (assets/js/content/flashN.js),
     each populating NETPLUS.flash[N] with 100 cards { id, d, t, obj, front, back }.
   - Scheduling state persists to localStorage (netplus.flash.v1) keyed by card id,
...
(function () {
  ...
  function ver() { return window.NETPLUS_VER ? "?v=" + window.NETPLUS_VER : ""; }
